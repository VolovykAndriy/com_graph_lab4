...
with open('DS5.txt', 'r', encoding='utf-8') as file_dataset, open('DS5New.txt', 'w',
                                                                  encoding='utf-8') as file_dataset_new:
...
draw_img = lambda coordArray: draw.line(
    (float(coordArray[0]) + 480, float(coordArray[1]) + 480, float(coordArray[0]) + 481,
     float(coordArray[1]) + 481), fill=15)
with open('DS5New.txt', 'r', encoding='utf-8') as file_dataset:
